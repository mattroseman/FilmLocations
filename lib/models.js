...
locationSchema.statics.getClustersInBounds = async function(southWest, northEast, clusterFactor=3, movieId) {
  ...
  // TODO check cache for each of these geohashes to see if they've already been calculated
  // TODO if they have remove them from geohashes so they won't be queried again
